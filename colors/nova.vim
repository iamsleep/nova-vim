...
function! s:highlight_helper(...)
  ...
  let l:background_color = empty(a:3) ? (exists('g:nova_transparent') ? "NONE" : "#000000") : a:3
...
call s:highlight_helper("ToolbarButton", "#1E272C", "#000000")
call s:highlight_helper("Question", "#7FC1CA", "")
call s:highlight_helper("MoreMsg", "#7FC1CA", "")
call s:highlight_helper("ModeMsg", "#7FC1CA", "")
call s:highlight_helper("StatusLine", "#7FC1CA", "#000000")
call s:highlight_helper("StatusLineTerm", "#7FC1CA", "#000000")
...
call s:highlight_helper("CursorLine", "NONE", "#000000")
call s:highlight_helper("CursorColumn", "NONE", "#000000")
call s:highlight_helper("ColorColumn", "NONE", "#000000")
call s:highlight_helper("EndOfBuffer", "#556873", "")
call s:highlight_helper("VertSplit", "#1E272C", "")
call s:highlight_helper("StatusLineNC", "#6A7D89", "#000000")
call s:highlight_helper("StatusLineTermNC", "#6A7D89", "#000000")
call s:highlight_helper("TabLine", "#000000", "#000000")
call s:highlight_helper("TabLineFill", "#000000", "#000000")
call s:highlight_helper("ToolbarLine", "#000000", "#000000")
call s:highlight_helper("Pmenu", "#C5D4DD", "#000000")
call s:highlight_helper("PmenuSbar", "#899BA6", "#000000")
call s:highlight_helper("fzf1", "#3C4C55", "#000000")
call s:highlight_helper("fzf2", "#3C4C55", "#000000")
call s:highlight_helper("fzf3", "#3C4C55", "#000000")
