...
function! s:highlight_helper(...)
  ...
  let l:background_color = empty(a:3) ? (exists('g:nova_transparent') ? "NONE" : "#1C1C1C") : a:3
...
call s:highlight_helper("ToolbarButton", "#1E272C", "#1C1C1C")
call s:highlight_helper("Question", "#7FC1CA", "")
call s:highlight_helper("MoreMsg", "#7FC1CA", "")
call s:highlight_helper("ModeMsg", "#7FC1CA", "")
call s:highlight_helper("StatusLine", "#7FC1CA", "#1C1C1C")
call s:highlight_helper("StatusLineTerm", "#7FC1CA", "#1C1C1C")
...
call s:highlight_helper("CursorLine", "NONE", "#1C1C1C")
call s:highlight_helper("CursorColumn", "NONE", "#1C1C1C")
call s:highlight_helper("ColorColumn", "NONE", "#1C1C1C")
call s:highlight_helper("EndOfBuffer", "#556873", "")
call s:highlight_helper("VertSplit", "#1E272C", "")
call s:highlight_helper("StatusLineNC", "#6A7D89", "#1C1C1C")
call s:highlight_helper("StatusLineTermNC", "#6A7D89", "#1C1C1C")
call s:highlight_helper("TabLine", "#1C1C1C", "#1C1C1C")
call s:highlight_helper("TabLineFill", "#1C1C1C", "#1C1C1C")
call s:highlight_helper("ToolbarLine", "#1C1C1C", "#1C1C1C")
call s:highlight_helper("Pmenu", "#C5D4DD", "#1C1C1C")
call s:highlight_helper("PmenuSbar", "#899BA6", "#1C1C1C")
call s:highlight_helper("fzf1", "#3C4C55", "#1C1C1C")
call s:highlight_helper("fzf2", "#3C4C55", "#1C1C1C")
call s:highlight_helper("fzf3", "#3C4C55", "#1C1C1C")
